...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (path.startsWith("/api/wuser/add")||path.startsWith("/api/wuser/send")||"/api/wuser/toAdd".equals(path) ||path.startsWith("/api/user/add")||"/api/oauth/login".equals(path) ||path.startsWith("/api/oauth/toIndex")|| !UrlFilter.hasAuthorize(path)){
            //直接放行
