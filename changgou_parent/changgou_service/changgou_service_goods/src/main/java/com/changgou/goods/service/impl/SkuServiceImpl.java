...
public class SkuServiceImpl implements SkuService {
    ...
    @Override
    public String findSpuIdBySkuId(String skuId) {

        Sku sku = new Sku();
        sku.setId(skuId);

        Sku resultSku = skuMapper.selectOne(sku);

        String spuId = resultSku.getSpuId();
        return spuId;
    }
     ...
     */
    @Override
    public void updateCommentCountBySkuId(String skuId, Integer count) {

        Sku sku = new Sku();
        sku.setId(skuId);
        sku.setCommentNum(count);
//        skuMapper.updateByPrimaryKeySelective(sku);

        skuMapper.updateCommentCountBySkuId(sku);
