...
public class SkuController {
    ...
    public List<Sku> findSkuListBySpuId(@PathVariable("spuId") String spuId){
        ...
        for (Sku sku : skuList) {
            ...
            String jsonSpec = JSON.toJSONString(map);
            sku.setSpec(jsonSpec);
        }
    ...
    @RequestMapping("/findSpuIdBySkuId")
    public String findSpuIdBySkuId(@RequestParam("skuId") String skuId){
        String spuId = skuService.findSpuIdBySkuId(skuId);
        return spuId;
    }

    @PostMapping("/updateCommentCountBySkuId")
    public void updateCommentCountBySkuId(@RequestParam("skuId") String skuId,@RequestParam("count") Integer count){
        skuService.updateCommentCountBySkuId(skuId,count);
    }

    @GetMapping("/hotGoods")
    public Result<List<Sku>> hotGoods(){
        List<Sku> skuList = skuService.findHotGoods();
